...
// MOCK_CAMPAIGNS is no longer the source of truth, Firestore is.
  ...
  const handleCreateCampaign = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: `Could not start campaign processing for "${campaignDataForAction.name}". Error: ${error instanceof Error ? error.message : String(error)}`,
        variant: "destructive",
      });
    } finally {
